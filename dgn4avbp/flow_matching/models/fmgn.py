...
class FlowMatchingGraphNet(FlowMatchingModel):
    r"""Defines a GNN that approximates the advection vector field of a flow matching model.
    ...
    def forward(
        ...
        # Encode the r embedding into the node features
